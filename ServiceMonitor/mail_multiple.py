...
def main():
    ...
    user_name, user_email = get_users_data('<path_to_script>/ServiceMonitor/mail_users.txt') # read user details
    
    # Send the message via local SMTP server.
    mail = smtplib.SMTP('<smtp_server>', <smtp_server>)
    ...
    for name, email in zip(user_name, user_email):
        ...
        fpattach = open("<path_to_script>/ServiceMonitor/<html_message_file>")
